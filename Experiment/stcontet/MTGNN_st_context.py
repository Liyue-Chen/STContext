...
import os
from UCTB.utils.utils_MTGNN_st import load_dataset
from UCTB.dataset import NodeTrafficLoader
...
data_dict = load_dataset(uctb_data_loader, args.batch_size, args.batch_size, args.batch_size,st_context_loader=stcontextloader)
